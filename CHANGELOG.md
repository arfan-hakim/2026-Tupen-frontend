## [1.1.0] - 2026-02-16
### Added
- Fitur Edit riwayat peminjaman melalui Modal Popup.
- Logika otomatis reset status menjadi "Pending" setelah data diedit.
- Fitur Soft Delete untuk menghapus baris riwayat.
